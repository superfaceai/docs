...
Click on _Import from URL_ and paste the URL of the _Action Schema_ from your Superface GPT Actions settings.

![The import from URL section.](/img/gpts/action-schema.png)

Click on _Import_ and OpenAI will fetch the schema from Superface.
...
Custom GPTs have the option of linking to an external Privacy Policy so to help with this Superface automatically generates a bespoke Privacy Policy URL for you to use. It lists all the tools that your GPT will have access to.

![Example of the Privacy Policy page that Superface generates for you.](/img/gpts/privacy-policy.png)

You can find the URL for the Privacy policy on the _GPT Actions_ settings page in Superface. It can be added to the _Privacy policy_ section of your Action setting in OpenAI.
