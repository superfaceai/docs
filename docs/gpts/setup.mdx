...
:::note What are Actions in GPTs?
Actions allow you to further customize your GPTs. To find out more about them take a look at the OpenAI [Actions in GPTs](https://platform.openai.com/docs/actions) documentation.
:::
