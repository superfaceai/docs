...
- [Getting Started](../introduction/quick-start-sdk.mdx) tutorial
...
By default, OneSDK picks the first configured provider, or the first provider according to profile's [`priority` array](../classic/reference/superjson#profilesettings) as specified in configuration.
