...
Superface is a language and a protocol for abstracting integrations as application use-cases. It allows use-case creation and distribution of integration code at runtime.
