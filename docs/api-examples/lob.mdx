...
You will need a Lob API key. Find out how to set that up in the [API Keys](https://dashboard.lob.com/settings/api-keys) section of Lob's Authentication documentation.
