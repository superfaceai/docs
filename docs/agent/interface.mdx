...
:::tip What are tools?
In Superface world, "Tools" are what connects the agent to your external services. They are built using our [Command Line Interface](../introduction/install-superface).
:::
